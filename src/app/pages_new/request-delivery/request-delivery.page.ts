...
export class RequestDeliveryPage implements OnInit {
  ...
  requestDelivery() {
    ...
    if (this.deliveryAddress==''){
      ...
      alert('Please fill in both delivery addresses.');
      return;

    }
    else if (this.deliveryDescription==''){
      alert('Please provide a description for the delivery.');
      return;
    }
    this.firestore.collection('deliveries').add({
      ...
      this.toastService.show('✅ Errand Request sent SUCCESSFULLY!!', 'success');
